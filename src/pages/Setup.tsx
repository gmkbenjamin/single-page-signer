                    ...
                    <div className="space-y-4 mb-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-background border border-border rounded-lg px-4 py-3 text-textMain focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
